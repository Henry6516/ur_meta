<template>
  <section>
    ...
    <!--</el-col>-->
    <!--</el-row>-->
    <el-form :model="editForm" :inline="true" label-width="100px" ref="editForm">
      ...
      <el-col :span="24">
        <el-col :span="6" style="margin-left:20px;">
          <a :href="editForm.picUrl" target="_blank">
            <img
              :src="editForm.picUrl"
      ...
      <el-row style="margin-top: 0px">
        <el-col :span="8" style="margin-top: 20px;">
          <el-col :span="5" style="text-align: center;margin-top: 8px" class="font13">商品图片链接</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.picUrl" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px" class="font13">是否备货</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.stockUp" style disabled></el-input>
            <!-- <el-select
        ...
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px" class="font13">商品编码</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.goodsCode" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col
          ...
          >*商品名称</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.goodsName" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col
          ...
          >*中文申报名</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.aliasCnName" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col
          ...
          >*英文申报名</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.aliasEnName" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">采购</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.purchaser" style disabled></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">业绩归属人1</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.developer" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">责任归属人1</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.possessMan1" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col
          ...
          >*供应商名称</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.supplierName" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="8" style="margin-top: 20px">
          <el-col
        ...
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">特殊属性必填</el-col>
          <el-col :span="18">
            <el-select
        ...
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;color: red" class="font13">*仓库</el-col>
          <el-col :span="18">
            <el-select
        ...
        <el-col :span="8" style="margin-top: 20px">
          ...
          <el-col :span="18">
            ...
            >
              <el-option
                v-for="(item, key) in mainCategory"
                :key="item.key"
                :label="item"
                :value="item"
              ></el-option>
        ...
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">子类目</el-col>
          <el-col :span="18">
            <el-select
              style="width: 100%"
              clearable
            ...
            >
              <el-option
                v-for="(item, key) in childrenCategory"
                :key="item.key"
                :label="item"
                :value="item"
              ></el-option>
        ...
        <el-col :span="8" style="margin-top: 20px">
          <el-col :span="5" style="text-align: center;margin-top: 8px;" class="font13">季节</el-col>
          <el-col :span="18">
            <el-select
        ...
        <el-col :span="8" style="margin-top: 20px">
          ...
          >*海关编码</el-col>
          <el-col :span="18">
            <el-input v-model="editForm.hsCode" style></el-input>
          </el-col>
        </el-col>
        <el-col :span="24" style="padding: 0;margin-left: 15px;">
        ...
        <el-col :span="24" style="margin-top: 10px;margin-bottom: 15px">
          <el-col :span="12">
            <span style="text-align: center;float: left;margin-left: 30px;margin-top: 6px">禁售平台</span>
          ...
          <el-col :span="12">
            <span style="text-align: center;float: left;margin-top: 6px">对应销售</span>
        ...
        <el-col :span="24">
          ...
          <el-col :span="20" style="margin-left: 15px;">
            <el-input
              ...
              style="width: 100%"
              class="aArial"
              placeholder="--tags关键词不能超过10个，逗号分隔--"
            ></el-input>
          </el-col>
        </el-col>
        ...
        <el-col :span="24">
          ...
          <el-col :span="23">
            <div style="margin-left: 70px">
              必填
              <el-input class="aArial" style="width:18.5%" v-model="randomData[0]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[1]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[2]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[3]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[4]" @blur="random()"></el-input>
            </div>
            <div style="margin-left: 70px;margin-top: 5px">
              选填
              <el-input class="aArial" style="width:18.5%" v-model="randomData[5]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[6]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[7]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[8]" @blur="random()"></el-input>
              <el-input class="aArial" style="width:18.5%" v-model="randomData[9]" @blur="random()"></el-input>
            </div>
          </el-col>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24" style="margin-bottom: 15px">
          <span
            style="text-align: right;margin-top: 8px;color: red;float: left;padding-left: 40px"
          >*描述</span>
          <el-col :span="22">
            <el-input
              type="textarea"
              ...
              class="aArial"
              style="width:96%;margin-left: 27px;font-family:Arial;"
            ></el-input>
          </el-col>
        </el-col>
      </el-row>
    </el-form>
    <el-form :model="oaGoods" :inline="true" label-width="100px" ref="oaGoods">
      <el-row style="margin-left: 10px">
        <el-col :span="8">
          <el-form-item label="供应商链接1">
            <el-input v-model="oaGoods.vendor1" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="供应商链接2">
            <el-input v-model="oaGoods.vendor2" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="供应商链接3">
            <el-input v-model="oaGoods.vendor3" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="平台链接1">
            <el-input v-model="oaGoods.origin1" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="平台链接2">
            <el-input v-model="oaGoods.origin2" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="平台链接3">
            <el-input v-model="oaGoods.origin3" style="width:360px"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    <el-col :span="24" style="padding: 0;margin-left: 15px;">
      <h3 class="toolbar essential" style="margin-top: 15px;margin-bottom: 15px">
        SKU
        <span
          style="float:right;margin-right: 78px;font-size: 14px;margin-bottom: 15px;display: block"
        >
          共{{skuTotal}}条
    ...
    >
      <el-table-column type="index" align="center" width="40" label="#" fixed header-align="center"></el-table-column>
      <el-table-column type="selection" align="center" width="40" fixed header-align="center"></el-table-column>
      <el-table-column label="操作" header-align="center" width="50" fixed align="center">
      ...
      <el-table-column label="SKU" prop="sku" fixed width="160" header-align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="款式1" prop="property1" width="160" fixed header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.property1"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="款式2" prop="property2" width="120" fixed header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.property2"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="款式3" prop="property3" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.property3"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="成本价" prop="costPrice" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.costPrice"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="重量" prop="weight" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.weight"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="零售价" prop="retailPrice" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.retailPrice"></el-input>
        </template>
      </el-table-column>
      ...
      <el-table-column label="joom运费" prop="joomShipping" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.joomShipping"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="备货数量" prop="stockNum" width="90" header-align="center">
        <template slot-scope="scope">
          <el-input size="small" v-model="scope.row.stockNum" v-if="editForm.stockUp=='是'"></el-input>
          <el-input size="small" v-model="scope.row.stockNum" disabled v-if="editForm.stockUp=='否'"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="供应商" width="200" prop="property2" header-align="center">
        <template slot-scope="scope">
          <el-select
    ...
    <div style="margin-top:15px;margin-left: 1%" class="pos">
      <el-button size="small" type="success" @click="oneKey()">一键生成SKU</el-button>
      <el-button size="small" type="warning" @click="passAll">导入普源</el-button>
      ...
      <el-button size="small" type="danger" @click="createOrder" :disabled="orderTrue">生成采购单</el-button>
      <el-button size="small" type="success" @click="synchro1688">同步1688</el-button>
      <el-select
        v-model="allSupplierValue"
        placeholder="请选择供应商"
        size="small"
        style="width:190px;"
      ...
      <el-button size="small" type="warning" @click="allStyle">一键填充款式</el-button>
      ...
      <span
        style="font-size:13px;color:red;margin-left:5px;"
      >提示：先同步1688->选择供应商->再选择1688规格，如果对应不了1688规格请选择无。</span>
      <!--<el-button size="small"-->
    ...
    <el-col
      :span="24"
      style="background: #fff;position: fixed;bottom: 0px; z-index:999;border-top: #eee solid 1px"
    >
      <el-col :span="24" :offset="8">
        <el-button
          type="primary"
          @click="save"
          style="width:350px;margin: 5px 0;margin-top: 8px;padding: 15px 0"
        >保存</el-button>
      </el-col>
    </el-col>
...
import {
  ...
  APISaveAttribute,
  APIAttribute,
  APISaveFinishAttribute,
  APIDeleteVariant,
  APIAttributeToShopElf,
  APIMakePurchasingOrder,
  APIsync1688Goods,
  APIget1688Suppliers,
  APIsync1688GoodStyle,
} from "../../api/product";
import {
  getMember,
  getGoodscats,
  getAttributeInfoPackName,
  getAttributeInfoSpecialAttribute,
  getAttributeInfoStoreName,
  getAttributeInfoSeason,
  getAttributeInfoPlat,
  getAttributeInfoSalesman,
  getAttributeInfoCat,
  ...
  methods: {
    ...
    passAll() {
      ...
      APIAttributeToShopElf(dataTe).then((res) => {
        if (res.data.code === 0) {
          this.$confirm(
            "该商品已导入过普源, 是否重新导入?\n重复SKU以下普源信息不会被更新：产品名称 产品状态 款式 成本价 重量 售价 网页URL 网页URL2 网页URL3 网页URL4 网页URL5 网页URL6 英文名称",
            "提示",
            {
    ...
    oneKey() {
      ...
      this.tableData.map((item, index, input) => {
        if (obj[item.property1] !== item.property1) {
          ...
          const k = ary.length;
          item.sku = `${this.editForm.goodsCode}${this.formatTen(k)}${
    ...
    getData() {
      APIAttributeInfo(this.condition).then((res) => {
        ...
        this.editForm.achieveStatus == "待处理"
          ? (this.saveFlag = true)
          : (this.saveFlag = false);
        this.editForm.requiredKeywords = JSON.parse(
          this.editForm.requiredKeywords
        );
